...
const Dev2QALogo = () => (
    <div className="flex items-center gap-3 font-sans">
        <div className="w-9 h-9">
            <Image src="/logo.jpg" alt="Dev2QA Logo" width={36} height={36} className="rounded-md" />
        </div>
    ...
    <svg className="h-32 w-32" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="text-accent/80">
            ...
            <g className="text-accent/90 font-sans font-semibold text-[9px] tracking-wider" fill="currentColor">
                <text><textPath href="#circlePath" startOffset="50%" textAnchor="middle">DEV2QA • QUALITY ASSURANCE</textPath></text>
            </g>
